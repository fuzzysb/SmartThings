 ...
 *
 *	Button Controller Plus based on the code from the smartthings button controller 
 *
...
definition(
    ...
    namespace: "fuzzysb",
    author: "Stuart Buchanan",
    description: "Control devices with buttons like the ZWave.Me KeyFob based on the code from the original smartthings button controller but includes the ability to configure the doubleclick values",
...
def getButtonSections(buttonNumber) {
	return {
		section("Lights") {
			...
			input "lights_${buttonNumber}_doubleclick", "capability.switch", title: "Double Clicked", multiple: true, required: false
		}
		section("Locks") {
			...
			input "locks_${buttonNumber}_doubleclick", "capability.lock", title: "Double Clicked", multiple: true, required: false
		}
		section("Sonos") {
			...
			input "sonos_${buttonNumber}_doubleclick", "capability.musicPlayer", title: "Double Clicked", multiple: true, required: false
		}
		section("Modes") {
			...
			input "mode_${buttonNumber}_doubleclick", "mode", title: "Double Clicked", required: false
		}
		...
		if (phrases) {
			section("Hello Home Actions") {
				...
				input "phrase_${buttonNumber}_doubleclick", "enum", title: "Double Clicked", required: false, options: phrases
			}
		}
        section("Sirens") {
			...
			input "sirens_${buttonNumber}_doubleclick", "capability.alarm", title: "Double Clicked", multiple: true, required: false
        }
        ...
        section("Push Notifications") {
			...
			input "notifications_${buttonNumber}_doubleclick", "bool", title: "Double Clicked", required: false, defaultValue: false
        }
        ...
        section("Sms Notifications") {
			...
			input "phone_${buttonNumber}_doubleclick", "phone", title: "Double Clicked", required: false
        }
	}
}
