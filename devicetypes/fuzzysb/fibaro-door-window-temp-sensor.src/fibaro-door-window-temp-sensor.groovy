 ...
 */
 metadata {
	definition (name: "Fibaro Door/Window Temp Sensor", namespace: "fuzzysb", author: "Stuart Buchanan") {      
	...
	tiles(scale: 2) {
		...
		main(["thermostat"])						//COMMENT ME OUT IF NO TEMP INSTALLED
		details(["thermostat", "contact", "battery"])			//COMMENT ME OUT IF NO TEMP INSTALLED
